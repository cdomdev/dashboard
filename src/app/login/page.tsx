...
export default function LoginPage() {
  ...
  return (
    <main>
      <section className="text-white  min-h-dvh bg-gradient-to-r from-[rgba(191,190,167,1)] via-[rgba(200,200,200,1)] to-[rgba(195,195,195,1)] bg-[112deg] flex pt-20  lg:pt-0 md:justify-center flex-col items-center gap-3 auth">
