...
export default function Aside() {
  ...
  return (
    <aside
      id="sidebar"
      className="fixed lg:block top-0 Back-0 z-40 w-64 h-screen pt-10 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
      aria-label="Sidebar"
    >
